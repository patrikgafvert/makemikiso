...
GLIBC_LIBC=$(SRC_BASE)$(GLIBC_DIR)build/libc.so
ZLIB_LIB=$(SRC_BASE)$(ZLIB_DIR)libz.so.$(ZLIB_VER)
LIBCRYPT_LIB=$(SRC_BASE)$(LIBCRYPT_DIR).libs/libcrypt.so.1
...
FILEUTIL_BIN=$(SRC_BASE)$(FILEUTIL_DIR)src/file
