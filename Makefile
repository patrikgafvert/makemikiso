...
run:
	qemu-system-x86_64 -m 2G -kernel $(SRC_BASE)$(LIXUX_DIR)arch/x86_64/boot/bzImage -initrd $(ROOT_BASE)$(INITRAMFS_FILE) -append "console=ttyS0" -enable-kvm -cpu host -nic user,model=e1000e -nographic
